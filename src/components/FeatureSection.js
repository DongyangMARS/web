    ...
    <section className="feature-section" id="feature">
      ...
      <div className="feature-list">
        <div className="game-card">
          <img className="game-image" src={FireMain} alt="멍하니, 불처럼 게임 이미지" />
        ...
        <div className="game-card">
          <img className="game-image" src={MoleMain} alt="화풀고 가실게요 게임 이미지" />
        ...
        <div className="game-card">
          <img className="game-image" src={FishingMain} alt="세월을 낚아라 게임 이미지" />
        ...
        <div className="game-card">
          <img className="game-image" src={AnimalMain} alt="동물 키우기 게임 이미지" />
